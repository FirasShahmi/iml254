...
var slider6 = initSlider('slider6');
var slider7 = initSlider('slider7');
...
document.querySelector('#slider6 .prev').onclick = () => slider6.plusSlides(-1);
document.querySelector('#slider6 .next').onclick = () => slider6.plusSlides(1);
document.querySelectorAll('#slider6 .dot').forEach((dot, index) => {
  dot.onclick = () => slider6.currentSlide(index + 1);
}); 

document.querySelector('#slider7 .prev').onclick = () => slider7.plusSlides(-1);
document.querySelector('#slider7 .next').onclick = () => slider7.plusSlides(1);
document.querySelectorAll('#slider7 .dot').forEach((dot, index) => {
  dot.onclick = () => slider7.currentSlide(index + 1);
});
